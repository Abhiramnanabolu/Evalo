                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-4xl md:text-5xl lg:mt-16 xl:text-[5.25rem]">
                                        Create Tests in Minutes, Not Hours.
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-3xl text-balance text-lg">
                                        Fast. Flexible. Powerful. The modern way to create, deliver, and evaluate tests.
                                    </p>
                                </AnimatedGroup>
